...
export default function ExerciciosPage() {
  ...
  if (!modulo || questoes.length === 0) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center">
        <p className="text-slate-400 mb-4">Nenhuma questão encontrada.</p>
  ...
  // Tela final
  if (questaoAtual === questoes.length - 1 && respondida) {
      ...
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 text-center">
            ...
            <h2 className="text-3xl font-black text-white mb-2">Exercícios Concluídos!</h2>
            <p className="text-blue-100 mb-6">{modulo.titulo}</p>
        ...
        <div className="max-w-4xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <p className="text-sm text-slate-500">Exercícios</p>
