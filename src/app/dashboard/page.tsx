...
import { LayoutDashboard, Swords, BookX, Lightbulb, Home } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/plataforma/enem" className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
            ...
            <div className="flex items-center gap-3">
              <Link href="/plataforma/enem" className="p-2 rounded-lg bg-slate-800/50 text-slate-400 hover:text-white">
